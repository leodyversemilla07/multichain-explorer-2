...
# -*- coding: utf-8 -*-
"""
FastAPI Agents Skill Search - BM25 search for FastAPI patterns and best practices
Usage: python search.py "<query>" [--domain <domain>] [-n <max_results>]

Domains: routing, dependencies, middleware, schemas, auth, testing, performance, errors
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="FastAPI Agents Skill Search")
